...
use ToxyTech\DevTool\Commands\Abstracts\BaseMakeCommand;
use ToxyTech\DevTool\Helper;
use ToxyTech\PluginManagement\Commands\Concern\HasPluginNameValidation;
...
class PluginCreateCommand extends BaseMakeCommand implements PromptsForMissingInput
{
    ...
    protected function registerAdvancedLanguage(): string|null
    {
        ...
        return PHP_EOL . str_repeat(' ', 12) . sprintf("if (defined('LANGUAGE_ADVANCED_MODULE_SCREEN_NAME')) {
                \ToxyTech\LanguageAdvanced\Supports\LanguageAdvancedManager::registerModule(%s::class, [
                    'name',
                ]);
    ...
    protected function importsServiceProvider(): string|null
    {
        ...
        $imports = ['ToxyTech\Base\Facades\DashboardMenu'];
